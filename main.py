...
def display_score():
    ...
    # score_surf = font.render(f'{int(current_time / 1000)}', False, (64, 64, 64)) - check to see if he responds to coment on video re this solution.
...
game_msg = font.render('Press space to run', False, (111, 196, 169))
